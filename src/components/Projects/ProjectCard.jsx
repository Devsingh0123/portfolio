    ...
    <div className="p-3 md:p-6 flex flex-col w-80 bg-[#0c0e19] rounded-lg shadow-xl shadow-slate-900 ">
      ...
      <div className="mt-2 p-2 md:p-4 flex gap-2 md:gap-4">
        <a href={demoLink} target="_blank">
          <button className="md:mt-10 text-white py-2 px-3 text-sm md:text-lg md:py-2 md:px-4 hover:opacity-85 duration-300 hover:scale-105 font-semibold rounded-3xl bg-[#5dade243] cursor-pointer">
            Demo
          </button>
        </a>
